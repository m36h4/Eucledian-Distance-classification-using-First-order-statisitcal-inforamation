...
def main():
	...
	myb = 0
	myc = 0
	with open('/home/megha/Desktop/separable/mean.csv', 'r') as csvfile:
	...
	with open('/home/megha/Desktop/separable/train.csv', 'r') as csvfile:
		lines = csv.reader(csvfile)
		dataset = list(lines)
		for x in range(len(dataset)):
			for y in range(2):
	...
	with open('/home/megha/Desktop/separable/mean.csv', 'r') as csvfile:
		...
		for x in range(len(dataset)):
	       ...
	       # else:
	          #  testSet.append(dataset[x])
	with open('/home/megha/Desktop/separable/test.csv', 'r') as csvfile:
		lines = csv.reader(csvfile)
		dataset = list(lines)
		for x in range(len(dataset)):
			for y in range(2):
	...
	for x in range(len(testSet)):
		if testSet[x][-1] =='Class 1':
			var = var_atr
		elif testSet[x][-1] =='Class 2':
			var = var_gen
		elif testSet[x][-1] =='Class 2':
			var = var_obs
	...
	print(DataFrame(cm, columns=['Class 1', 'Class 2', 'Class 3'], index=['Class 1', 'Class 2', 'Class 3']))
